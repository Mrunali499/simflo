...
export const EmptyStateCard = () => {
    return (
        <View className="flex-1 items-center justify-center bg-white">
            <View className="w-[268px] h-[174px] items-center relative">
                ...
                <Text className="text-text-header font-semibold text-[24px] mb-2 text-center leading-[21px] tracking-[-0.32px]">
                    No visitors added yet
                </Text>
                <Text className="absolute left-0 top-[124px] w-[268px] h-[50px] text-text-description font-medium text-[18px] text-center leading-[25px] tracking-[-1px]">

...
export const ConversationHeader = ({ title = 'Conversations', headerRight }: { title?: string; headerRight?: React.ReactNode }) => {
    ...
    return (
        <View className="bg-white pb-3" style={{ paddingTop: Math.max(insets.top, 20) }}>
            <View className="flex-row items-center justify-between pr-4">
                ...
                {headerRight && <View className="mt-4">{headerRight}</View>}
            </View>
            <Input
                placeholder="Search..."
